    ...
    <form action="{{ route('book.update', $book->getKey()) }}" method="post">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="penulis" id="penulis" aria-describedby="helppenulis"
                placeholder="Tulis nama penulis"  value="{{ old('penulis') ?? $book->penulis }}">
            @error('penulis')
        ...
        <div class="form-group">
            ...
            <input type="year" class="form-control" name="tahun" id="tahun" aria-describedby="helptahun"
                placeholder="Tulis tahun terbit"  value="{{ old('tahun') ?? $book->tahun }}">
            @error('tahun')
        ...
        <div class="form-group">
            ...
            <textarea class="form-control" name="sinopsis" id="sinopsis" aria-describedby="helpsinopsis" rows="3" placeholder="Tulis sinopsis">{{ old('sinopsis') ?? $book->sinopsis }}</textarea>
            @error('sinopsis')
